...
attribute_names(Module) ->
    ...
    Module:attribute_names(DummyRecord).


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
attribute_types(Module) ->
    DummyRecord = dummy_record(Module),
    Module:attribute_types(DummyRecord).


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
database_columns(Module) ->
    DummyRecord = dummy_record(Module),
    Module:database_columns(DummyRecord).


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
database_table(Module) ->
    DummyRecord = dummy_record(Module),
    Module:database_table(DummyRecord).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
belongs_to_types(Module) when is_atom(Module) ->
    DummyRecord = dummy_record(Module),
    Module:belongs_to_types(DummyRecord).
