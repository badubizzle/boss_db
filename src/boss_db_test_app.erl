            ...
            [
              ...
              fun([Id1|_]) ->
                  do(fun() ->
                        ...
                        UpdatedRecord = Module:set([{some_integer, 43}], Record),
                        {ok, SavedRecord} = Module:save(UpdatedRecord),
                        SavedRecord
                    end,
                    [
                      fun(SavedRecord) ->
                          Module = element(1, SavedRecord),
                          {Module:get(some_integer, SavedRecord) =:= 43,
